                ...
                <tbody>
                    {props.selections.map(selection =>
                        <tr key={selection.product.id}>
                            ...
                            <td className="text-right">${selection.product.price.toFixed(2)}</td>
                            <td className="text-right">${Helpers.total([selection]).toFixed(2)}</td>
                        </tr>
                    )}
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <th className="text-right">${Helpers.total(props.selections).toFixed(2)}</th>
                    </tr>
                </tfoot>
            </table>
        </div>
